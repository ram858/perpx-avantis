...
function recordAIPOS(symbol, entry, txHash, signalScore, marketRegime, tp, sl, rsi, macdHist, emaSlope, atrPct, leverage, atr, adx, adxSlope, volumePct, perPositionBudget, breakevenActivated = false, trailingTPPct = 0, divergenceScore = 0, tradeType = 'standard', note = '', phase, highestFav, lowestFav, slPrice, triggeredByOverride, entryReasonOverride, extraTP, extraSL, extraRRR, side // Add side parameter
) {
    ...
    const updated = {
        ...
        triggeredBy,
        entryReason,
        side, // Store the side information
        rrr: extraRRR,
